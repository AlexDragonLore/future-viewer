...
Онлайн ТАРО-расклад с AI-интерпретацией через OpenAI-compatible провайдера. «Future Viewer» — внутреннее имя репозитория и неймспейсов; пользовательское название — «Вуаль Грядущего».
